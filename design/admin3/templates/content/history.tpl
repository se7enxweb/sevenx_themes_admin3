        ...
        <div id="fix">
            ...
            <div class="message-warning">
                <h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span>
                    {'Version is not a draft'|i18n( 'design/admin/content/history' )}</h2>
                <ul>
                    <li>{'Version %1 is not available for editing anymore. Only drafts can be edited.'|i18n( 'design/admin/content/history',, array( $edit_version ) )}
                    </li>
            ...
            <div class="message-warning">
                <h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span>
                    {'Version is not yours'|i18n( 'design/admin/content/history' )}</h2>
                <ul>
                    <li>{'Version %1 was not created by you. You can only edit your own drafts.'|i18n( 'design/admin/content/history',, array( $edit_version ) )}
                    </li>
                    <li>{'To edit this version, first create a copy of it.'|i18n( 'design/admin/content/history' )}</li>
                </ul>
            </div>
            ...
            <div class="message-warning">
                <h2><span class="time">[{currentdate()|l10n( shortdatetime )}]</span>
                    {'Unable to create new version'|i18n( 'design/admin/content/history' )}</h2>
                <ul>
                    <li>{'Version history limit has been exceeded and no archived version can be removed by the system.'|i18n( 'design/admin/content/history' )}
                    </li>
                    <li>{'You can change your version history settings in content.ini, remove draft versions or edit existing drafts.'|i18n( 'design/admin/content/history' )}
                    </li>
                </ul>
            </div>
            {/case}
                    ...
                    {* DESIGN: Header START *}<div class="box-header">
                        <div class="box-ml">
                            <h1 class="context-title">
                                {'Versions for <%object_name> (%version_count)'|i18n( 'design/admin/content/history',, hash( '%object_name', $object.name, '%version_count', $list_count ) )|wash}
                            </h1>
                        ...
                        <div class="box-mr">
                            <div class="box-content">
                             ...
                             $can_edit_lang = 0}
                                            <tr class="{$seq}">
                                                ...
                                                <td>
                                                    {if and( $version.can_remove, array( 0, 3, 4, 5 )|contains( $version.status ) )}
                                                        <input type="checkbox" name="DeleteIDArray[]" value="{$version.id}"
                                                            title="{'Select version #%version_number for removal.'|i18n( 'design/admin/content/history',, hash( '%version_number', $version.version ) )}" />
                                                    {else}
                                                        <input type="checkbox" name="_Disabled" value="" disabled="disabled"
                                                            title="{'Version #%version_number cannot be removed because it is either the published version of the object or because you do not have permission to remove it.'|i18n( 'design/admin/content/history',, hash( '%version_number', $version.version ) )}" />
                                                    {/if}
                                                </td>
                                                    ...
                                                    {if and( $can_edit, $can_edit_lang )}
                                                        {if eq( $version.status, 5 )}
                                                            <input type="image" src={'copy-disabled.gif'|ezimage} name="_Disabled"
                                                                ...
                                                                title="{'There is no need to make copies of untouched drafts.'|i18n( 'design/admin/content/history' )}" />
                                                        {else}
                                                            <input type="hidden" name="CopyVersionLanguage[{$version.version}]"
                                                                value="{$initial_language.locale}" />
                                                            <input type="image" src={'copy.gif'|ezimage}
                                                                name="HistoryCopyVersionButton[{$version.version}]" value=""
                                                                title="{'Create a copy of version #%version_number.'|i18n( 'design/admin/content/history',, hash( '%version_number', $version.version ) )}" />
                                                        {/if}
                                                    {else}
                                                        <input type="image" src={'copy-disabled.gif'|ezimage} name="_Disabled"
                                                            value="" disabled="disabled"
                                                            title="{'You cannot make copies of versions because you do not have permission to edit the object.'|i18n( 'design/admin/content/history' )}" />
                                                    {/if}
                                                </td>
                                                ...
                                                <td>
                                                    {if and( array(0, 5)|contains($version.status), $version.creator_id|eq( $user_id ), $can_edit ) }
                                                        <input type="image" src={'edit.gif'|ezimage}
                                                            name="HistoryEditButton[{$version.version}]" value=""
                                                            title="{'Edit the contents of version #%version_number.'|i18n( 'design/admin/content/history',, hash( '%version_number', $version.version ) )}" />
                                                    {else}
                                                        <input type="image" src={'edit-disabled.gif'|ezimage}
                                                            name="HistoryEditButton[{$version.version}]" value=""
                                                            disabled="disabled"
                                                            title="{'You cannot edit the contents of version #%version_number either because it is not a draft or because you do not have permission to edit the object.'|i18n( 'design/admin/content/history',, hash( '%version_number', $version.version ) )}" />
                                                    {/if}
                                                </td>
                                ...
                                {else}
                                    <div class="block">
                                        <p>{'This object does not have any versions.'|i18n( 'design/admin/content/history' )}
                                        </p>
                                    </div>
                                {/if}
         ...
         item_limit=$page_limit}
                            ...
                            <div class="box-ml">
                                ...
                                <div class="block">
                                    <div class="button-left">
                                        <input class="button" type="submit" name="RemoveButton"
                                            value="{'Remove selected'|i18n( 'design/admin/content/history' )}"
                                            title="{'Remove the selected versions from the object.'|i18n( 'design/admin/content/history' )}" />
                                    ...
                                    {if $object.can_diff}
                                        ...
                                        <div class="button-right">
                                            ...
                                            <input class="button" type="submit" name="DiffButton"
                                                value="{'Show differences'|i18n( 'design/admin/content/history' )}" />
                                        </div>
                                    {/if}
                ...
                {if and( is_set( $object ), is_set( $diff ), is_set( $oldVersion ), is_set( $newVersion ) )|not}
                    ...
                    <div class="context-block">
                        ...
                        {* DESIGN: Content START *}<div class="box-bc">
                            <div class="box-ml">
                                <div class="box-content">
                                    ...
                                    <table class="list" cellspacing="0">
                                        <tr>
                                            ...
                                            <th>{'Created'|i18n( 'design/admin/content/history' )}</th>
                                            <th>{'Modified'|i18n( 'design/admin/content/history' )}</th>
                                            <th class="tight">{'Copy translation'|i18n( 'design/admin/content/history' )}
                                            </th>
                                            <th class="tight">&nbsp;</th>
                                        </tr>
                                            ...
                                            <td align="right" class="right">
                                                <select name="CopyVersionLanguage[{$published_item.version}]">
                                                    {foreach $published_item.language_list as $lang_list}
                                                        <option value="{$lang_list.language_code}"
                                                            {if $lang_list.language_code|eq($published_item.initial_language.locale)}
                                                            selected="selected" {/if}>
                                                            {$lang_list.locale.intl_language_name|wash}</option>
                                                    {/foreach}
                                                </select>
                                            </td>
                    ...
                    <div class="context-block">
                        {* DESIGN: Header START *}<div class="box-header">
                            <div class="box-ml">
                                <h2 class="context-title">
                                    {'New drafts (%newerDraftCount)'|i18n( 'design/admin/content/history',, hash( '%newerDraftCount', $newerDraftVersionListCount ) )}
                                </h2>
                        ...
                        {* DESIGN: Content START *}<div class="box-bc">
                            ...
                            sequence array( bglight, bgdark ) as $seq}
                                            ...
                                            <tr class="{$seq}">
                                                ...
                                                <td align="right" class="right">
                                                    ...
                                                    {if and( $can_edit, $can_edit_lang )}
                                                        <input type="hidden" name="CopyVersionLanguage[{$draft_version.version}]"
                                                            value="{$initial_language.locale}" />
                                                        <input type="image" src={'copy.gif'|ezimage}
                                                            name="HistoryCopyVersionButton[{$draft_version.version}]" value=""
                                                            title="{'Create a copy of version #%version_number.'|i18n( 'design/admin/content/history',, hash( '%version_number', $draft_version.version ) )}" />
                                                    {else}
                                                        <input type="image" src={'copy-disabled.gif'|ezimage} name="_Disabled"
                                                            value="" disabled="disabled"
                                                            title="{'You cannot make copies of versions because you do not have permission to edit the object.'|i18n( 'design/admin/content/history' )}" />
                                                ...
                                                <td>
                                                    {if and( array(0, 5)|contains($draft_version.status), $draft_version.creator_id|eq( $user_id ), $can_edit ) }
                                                        <input type="image" src={'edit.gif'|ezimage}
                                                            name="HistoryEditButton[{$draft_version.version}]" value=""
                                                            title="{'Edit the contents of version #%version_number.'|i18n( 'design/admin/content/history',, hash( '%version_number', $draft_version.version ) )}" />
                                                    {else}
                                                        <input type="image" src={'edit-disabled.gif'|ezimage}
                                                            name="HistoryEditButton[{$draft_version.version}]" disabled="disabled"
                                                            value=""
                                                            title="{'You cannot edit the contents of version #%version_number either because it is not a draft or because you do not have permission to edit the object.'|i18n( 'design/admin/content/history',, hash( '%version_number', $draft_version.version ) )}" />
                                                    {/if}
                                                </td>
                                ...
                                {else}
                                    <div class="block">
                                        <p>{'This object does not have any drafts.'|i18n( 'design/admin/content/history' )}
                                        </p>
                                    </div>
                                {/if}
            ...
            {* DESIGN: Header START *}<div class="box-header">
                <div class="box-ml">
                    <h2 class="context-title">
                        {'Differences between versions %oldVersion and %newVersion'|i18n( 'design/admin/content/history',, hash( '%oldVersion', $oldVersion, '%newVersion', $newVersion ) )}
                    </h2>
                            ...
                            <div class="button-left">
                                <p class="table-preferences">
                                    <a href="JavaScript:void(0);"
                                        onclick="show('diffview', 'previous'); return false;">{'Old version'|i18n( 'design/admin/content/history' )}</a>
                                    <a href="JavaScript:void(0);"
                                        onclick="show('diffview', 'inlinechanges'); return false;">{'Inline changes'|i18n( 'design/admin/content/history' )}</a>
                                    <a href="JavaScript:void(0);"
                                        onclick="show('diffview', 'blockchanges'); return false;">{'Block changes'|i18n( 'design/admin/content/history' )}</a>
                                    <a href="JavaScript:void(0);"
                                        onclick="show('diffview', 'latest'); return false;">{'New version'|i18n( 'design/admin/content/history' )}</a>
                                </p>
                            </div>
            ...
            <div class="left">
                <form action={concat( '/content/history/', $object.id, '/' )|ezurl} method="post">
                    <input class="button" type="submit"
                        value="{'Back to history'|i18n( 'design/admin/content/history' )}" />
                </form>
            </div>
        </div>
        {/if}
